...
class _MapsScreenState extends State<MapsScreen> {
  ...
  Color _colorForCategory(String? name) {
    switch ((name ?? '').toLowerCase()) {
      case 'rumah sakit':
        return const Color(0xFFD32F2F); // red — emergency/hospital
      case 'klinik':
        return const Color(0xFF1976D2); // blue — clinic
      case 'puskesmas':
        return const Color(0xFFF57C00); // orange — community health center
      default:
